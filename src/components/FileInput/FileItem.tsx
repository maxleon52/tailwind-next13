...
const fileItem = tv({
  slots: {
    ...
    icon: "rounded-full border-4 border-violet-50 bg-violet-200 p-2 text-violet-600",
    deleteButton: "",
  },
  ...
  variants: {
    state: {
      ...
      error: {
        ...
        icon: "bg-error-50 border-error-100 text-error-600",
    ...
    <div className={container()}>
      ...
      {state === "error" ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <button className="text-sm font-semibold text-error-600">
            Try again
          </button>
        </div>
      ) : (
